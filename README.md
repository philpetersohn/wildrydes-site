# Playing with some AWS services

This repo contains the code files used in this [YouTube video](https://youtu.be/K6v6t5z6AsU). I used this project to get some understanding how AWS works. 
